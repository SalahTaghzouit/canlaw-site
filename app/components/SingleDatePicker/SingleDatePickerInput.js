...
import DateInput from 'react-dates/lib/components/DateInput';
import CloseButton from 'react-dates/src/svg/close.svg';
...
export default class SingleDatePickerInput extends React.Component {
  ...
  render() {
    ...
    return (
      <div className={`SingleDatePickerInput ${className}`}>
        <DateInput
          id={id}
